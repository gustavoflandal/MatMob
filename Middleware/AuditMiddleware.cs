    ...
    public class AuditMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, IPermissionService permissionService)
        {
            ...
            try
            {
                ...
                {
                    await LogAuditEvent(context, startTime, endTime, duration, permissionService);
                }
        ...
        private async Task LogAuditEvent(HttpContext context, DateTime startTime, DateTime endTime, TimeSpan duration, IPermissionService permissionService)
        {
            try
            {
