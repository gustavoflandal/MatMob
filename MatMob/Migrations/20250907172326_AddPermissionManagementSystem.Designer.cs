...
namespace MatMob.Migrations
{
    ...
    [Migration("20250907172326_AddPermissionManagementSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatMob.Models.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("MatMob.Models.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("MatMob.Models.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("PermanentRetention")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("MatMob.Models.Entities.AuditModuleConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Module", "Process")
                        .IsUnique();

                    b.ToTable("AuditModuleConfigs");
                });
            ...
            modelBuilder.Entity("MatMob.Models.Entities.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MatMob.Models.Entities.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MatMob.Models.Entities.UserPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MatMob.Models.Entities.RolePermission", b =>
                {
                    b.HasOne("MatMob.Models.Entities.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MatMob.Models.Entities.ApplicationRole", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("MatMob.Models.Entities.UserPermission", b =>
                {
                    ...
                    b.HasOne("MatMob.Models.Entities.ApplicationUser", "User")
                        .WithMany("UserPermissions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("MatMob.Models.Entities.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MatMob.Models.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
